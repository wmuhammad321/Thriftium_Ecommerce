	...
	"post">
				...
				<?php
				  ...
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		...
				  		echo '<td> Rp. '.number_format($result->PROPRICE,2).' </td>';
				  		echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
				  		?>
				  		 <td> Rp. <output><?php echo number_format($result->ORDEREDPRICE,2); ?></output></td> 
				  		<?php
       ...
       <div class="row">
		  	...
		  	<div class="col-md-6 pull-right">
		  		...
		  		<p align="right">Delivery Fee : Rp. <?php echo number_format($cur->DELFEE,2); ?></p>
