            ...
            <tr>
              ...
              <!--   <div class="col-md-6 pull-left">
                ...
                <div class="col-md-4 pull-right">
                  <!-- <div>Total Price : Rp. <?php echo number_format($tot,2);?></div> -->
                  <!-- <div>Delivery Fee : Rp. <?php echo number_format($price,2); ?></div> -->
                  <div>Overall Price : Rp. <?php echo number_format($cur->TOTALPRICE,2); ?></div>
                </div>
              </div>
