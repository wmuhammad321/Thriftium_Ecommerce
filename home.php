          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>Triftium</span></h1>
                  <h2>Beli 2 Dapat potongan harga % 15</h2>
                  <p>DISKON 15% untuk pembeli yang mengikuti LIVE di Instagram Mulai 1 s/d 30 Januari 2022. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Triftium</span></h1>
                  <h2>Mendapatkan diskon senilai 15%  setiap pembelian hari Jum'at.</h2>
                  <p>Mulai 15.00 - 18.00 WIB </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>Triftium</span></h1>
                  <h2>Dapatkan potongan harga menarik mulai tanggal  25 april 2022.</h2>
                  <p>Beli 3 Produk ini hanya dengan harga 300.000 </p>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h2>Rp. <?php  echo $result->PRODISPRICE; ?></h2>
