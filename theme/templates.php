...
<head >
    ...
    <title>Home | Triftium-Ebis</title>
...
<body  onload="totalprice()" >
  ...
  <header id="header" ><!--header-->
    <div class="header_top" style="background-color:#7DBCB8"><!--header_top-->
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
              <li><a href="https://api.whatsapp.com/send/?phone=6285887089150&text=Saya+ingin+konformasi+barang+yang+saya+beli&app_absent=0/"> Send WhatsApp </a><i class="fa fa-phone"></i> 0858870889150&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
               
              <li><a href="https://mail.google.com/mail/u/0/#inbox" > Send e-mail </a><i class=" fa fa-envelope"></i> skuuuyliving@gmail.com </a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logoooo.png" alt="" /></a>
            </div> 
          </div>
    ...
    <footer id="footer" style="background-color:rgba(243, 219, 138, 0.87)" >   <!--Footer-->
    <div class="footer-top">
      <div class="container">
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span><strong>Triftium</strong></span></h2>
              <p><strong>Your Quality Thrift Store</strong></p>
            </div>
          </div>  
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              <img src="images/home/mapindo.png" alt="" />
              <p>Indonesia</p>
            </div>
          </div>
        </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p><strong>Other Information down below</strong> </p>
        <div class="row">
          <div class="col-sm-3">
